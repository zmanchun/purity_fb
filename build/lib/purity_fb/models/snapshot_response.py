...
class SnapshotResponse(object):
    ...
    def items(self):
        """
        Gets the items of this SnapshotResponse.

        :return: The items of this SnapshotResponse.
        :rtype: list[Snapshot]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this SnapshotResponse.

        :param items: The items of this SnapshotResponse.
        :type: list[Snapshot]
        """
        if items is None:
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this SnapshotResponse.
        paging information

        :return: The pagination_info of this SnapshotResponse.
    ...
    def pagination_info(self, pagination_info):
        """
        Sets the pagination_info of this SnapshotResponse.
        paging information

        :param pagination_info: The pagination_info of this SnapshotResponse.
        :type: PaginationInfo
        """
